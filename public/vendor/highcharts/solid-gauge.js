...
(function (a) {
  ...
  f(
    a,
    "Series/SolidGauge/SolidGaugeComposition.js",
    ...
    function (a) {
      ...
      a.symbols.arc = function (a, c, e, m, b) {
        ...
        b &&
          b.rounded &&
          ((e = ((b.r || e) - (b.innerR || 0)) / 2),
          (c = a[0]),
          (b = a[2]),
          "M" === c[0] &&
            "L" === b[0] &&
            ((c = ["A", e, e, 0, 1, 1, c[1], c[2]]),
            (a[2] = ["A", e, e, 0, 1, 1, b[1], b[2]]),
            (a[4] = c)));
        return a;
      };
    }
  ...
  f(
    ...
    function (a, k, l, c) {
      var e =
        ...
        g = c.pick,
        v = c.pInt,
        d = { colorByPoint: !0, dataLabels: { y: 0 } };
      c = (function (a) {
        function c() {
        ...
        c.prototype.drawPoints = function () {
          ...
          n(e.threshold) &&
            (f =
              b.startAngleRad + b.translate(e.threshold, null, null, null, !0));
          this.thresholdAngleRad = g(f, b.startAngleRad);
          a.points.forEach(function (d) {
            if (!d.isNull) {
              var h = d.graphic,
                f = b.startAngleRad + b.translate(d.y, null, null, null, !0),
                m = (v(g(d.options.radius, e.radius, 100)) * c[2]) / 200,
                q =
                  (v(g(d.options.innerRadius, e.innerRadius, 60)) * c[2]) / 200,
                r = b.toColor(d.y, d),
              ...
              d.startR = m;
              h
                ? ((m = q.d), h.animate(u({ fill: r }, q)), m && (q.d = m))
                : (d.graphic = h =
                    k.arc(q).attr({ fill: r, "sweep-flag": 0 }).add(a.group));
              a.chart.styledMode ||
                ("square" !== e.linecap &&
                  h.attr({
