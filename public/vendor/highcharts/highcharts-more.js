...
(function (e) {
  ...
  y(
    ...
    function (e, c, d, l, a, n) {
      function f(b, a, h) {
        return (
          Math.sqrt(Math.pow(b - h[0], 2) + Math.pow(a - h[1], 2)) <= h[2] / 2
        );
      }
      var r = a.addEvent,
        q = a.extend,
            ...
            for (
              ...
              a[p] && this.axis
                ? this.renderBackground(
                    w(this.defaultBackgroundOptions, a[p]),
                    p
                  )
                : this.background[p] &&
        ...
        h.polar
          ? ((h.hoverPane = h.getHoverPane(a)),
            (a.filter = function (p) {
              return (
                p.visible &&
                !(!a.shared && p.directTouch) &&
                b(p.options.enableMouseTracking, !0) &&
                (!h.hoverPane || p.xAxis.pane === h.hoverPane)
              );
            }))
          : (h.hoverPane = void 0);
      });
      r(l, "afterGetHoverData", function (b) {
        ...
        b.hoverPoint &&
          ...
          b.hoverPoint.plotY &&
          a.hoverPane &&
          !f(b.hoverPoint.plotX, b.hoverPoint.plotY, a.hoverPane.center) &&
          (b.hoverPoint = void 0);
      });
      c.Pane = a;
      return c.Pane;
        ...
        a.init = function (a) {
          ...
          a.getLinePath = function (b, a, t) {
            ...
            var k = this.chart,
              ...
              m = this.top || 0;
            "undefined" === typeof t &&
              (t = this.horiz ? 0 : this.center && -this.center[3] / 2);
            t && (g += t);
            this.isCircular || "undefined" !== typeof a
              ? ((a = this.chart.renderer.symbols.arc(
                  u + b[0],
                  m + b[1],
                  g,
                  g,
              ...
              : ((a = this.postTranslate(this.angleRad, g)),
                (a = [
                  [
                    "M",
                    this.center[0] + k.plotLeft,
                    this.center[1] + k.plotTop,
                  ],
                  ["L", a.x, a.y],
                ]));
            return a;
          ...
          a.beforeSetTickPositions = function () {
            this.autoConnect =
              this.isCircular &&
              "undefined" === typeof h(this.userMax, this.options.max) &&
          ...
          a.setAxisSize = function () {
            ...
            if (this.isRadial) {
              ...
              this.len =
                this.width =
                this.height =
                  ((b[2] - b[3]) * h(this.sector, 1)) / 2;
            }
          };
          a.getPosition = function (b, a) {
            b = this.translate(b);
            return this.postTranslate(
              this.isCircular ? b : this.angleRad,
              h(this.isCircular ? a : 0 > b ? 0 : b, this.center[2] / 2) -
                this.offset
            );
          };
          a.postTranslate = function (b, a) {
            ...
            return {
              x: t.plotLeft + k[0] + Math.cos(b) * a,
              y: t.plotTop + k[1] + Math.sin(b) * a,
            };
          };
          a.getPlotBandPath = function (b, a, t) {
            ...
            if ("polygon" === this.options.gridLineInterpolation)
              A = this.getPlotLinePath({ value: b }).concat(
                this.getPlotLinePath({ value: a, reverse: !0 })
              );
            else {
              ...
              D -= A;
              A = this.chart.renderer.symbols.arc(x + g[0], z + g[1], D, D, {
                start: Math.min(t, u),
                end: Math.max(t, u),
                innerR: h(f, D - (k - A)),
                open: r,
              ...
              c &&
                ((c = (u + t) / 2),
                (x = x + g[0] + (g[2] / 2) * Math.cos(c)),
                (A.xBounds =
                  c > -Math.PI / 2 && c < Math.PI / 2
                    ? [x, this.chart.plotWidth]
                    : [0, x]),
                (A.yBounds = [z + g[1] + (g[2] / 2) * Math.sin(c)]),
                (A.yBounds[0] +=
                  (c > -Math.PI && 0 > c) || c > Math.PI ? -10 : 10));
            }
            return A;
          };
          a.getCrosshairPosition = function (b, a, t) {
            ...
            if (this.isCircular) {
                ...
                b.point &&
                  ...
                  u.start &&
                    (k = this.chart.inverted
                      ? this.translate(b.point.rectPlotY, !0)
                      : b.point.x));
              else {
                var u = b.chartX || 0;
                var m = b.chartY || 0;
                k = this.translate(
                  Math.atan2(m - t, u - a) - this.startAngleRad,
                  !0
                );
              }
              ...
              r(k) || ((u = b.chartX), (m = b.chartY)),
                r(u) &&
                  r(m) &&
                  ((t = g[1] + this.chart.plotTop),
                  (k = this.translate(
                    Math.min(
                      Math.sqrt(Math.pow(u - a, 2) + Math.pow(m - t, 2)),
                      g[2] / 2
                    ) -
                      g[3] / 2,
                    !0
          ...
          a.getPlotLinePath = function (b) {
            var a = this,
              ...
              m = b.reverse,
              A = a.getPosition(u),
              x = a.pane.options.background
                ? a.pane.options.background[0] || a.pane.options.background
                : {},
              h = x.innerRadius || "0%",
              c = x.outerRadius || "100%";
            x = t[0] + k.plotLeft;
            ...
            var l;
            b.isCrosshair &&
              ((r = this.getCrosshairPosition(b, x, f)),
              (u = r[0]),
              (D = r[1]),
              (r = r[2]));
            if (a.isCircular)
              ...
              ((u = a.translate(u)) && (0 > u || u > d) && (u = 0),
              "circle" === a.options.gridLineInterpolation)
            )
              t = a.getLinePath(0, u, A);
            else if (
              ((t = []),
              ...
              for (
                ...
                (f = l.getPosition(x[D], u)),
                  t.push(D ? ["L", f.x, f.y] : ["M", f.x, f.y]);
            return t;
          };
          a.getTitlePosition = function () {
            ...
            return {
              x: a.plotLeft + b[0] + (t.x || 0),
              y:
                a.plotTop +
                b[1] -
                { high: 0.5, middle: 0.25, low: 0 }[t.align] * b[2] +
                (t.y || 0),
            };
          };
          a.createLabelCollector = function () {
            ...
            return function () {
              if (
                ...
                b.tickPositions &&
                b.options.labels &&
                !0 !== b.options.labels.allowOverlap
              )
        ...
        a.compose = function (f, d) {
          n(f, "init", function (h) {
            ...
            if ("colorAxis" === m) this.isRadial = !1;
              ...
              if (k) {
                if ((A ? l.init(this) : a.init(this), (x = !u)))
                ...
                g &&
                  ...
                  t &&
                    ...
                    ((this.defaultPolarOptions.stackLabels =
                      c.defaultYAxisOptions.stackLabels),
              ...
              k || g
                ? ((this.isRadial = !0),
                  ...
                  this.labelCollector &&
                    z.labelCollectors.push(this.labelCollector))
                : (this.isRadial = !1);
              h && x && (h.axis = this);
              this.isCircular = x;
            }
          ...
          n(d, "afterGetLabelPosition", function (b) {
            ...
            if (t) {
              var k = t.getBBox(),
                ...
                A = g.align,
                x =
                  (((a.translate(this.pos) + a.startAngleRad + Math.PI / 2) /
                    Math.PI) *
                    180) %
                  360,
                c = Math.round(x),
              ...
              if (a.isRadial) {
                var q = a.getPosition(
                  this.pos,
                  a.center[2] / 2 +
                    p(h(g.distance, -25), a.center[2] / 2, -a.center[2] / 2)
                );
                "auto" === g.rotation
                  ? t.attr({ rotation: x })
                  : r(u) ||
                    (u =
                      a.chart.renderer.fontMetrics(
                        t.styles && t.styles.fontSize
                      ).b -
                      k.height / 2);
                r(A) ||
                  (a.isCircular
                    ? (k.width > (a.len * a.tickInterval) / (a.max - a.min) &&
                        (m = 0),
                      (A =
                        x > m && x < 180 - m
                          ? "left"
                ...
                if (
                  ...
                  if (
                    ...
                    a.pane.options.startAngle === c + 360 ||
                    a.pane.options.startAngle === c - 360
                  )
                    f = "start";
                  A =
                  ...
                  15 > d || (180 <= d && 195 > d)
                    ? (l = 0.3 * k.height)
                    : 15 <= d && 35 >= d
                    ? (l = "start" === f ? 0 : 0.75 * k.height)
                    : 195 <= d && 215 >= d
                    ? (l = "start" === f ? 0.75 * k.height : 0)
                    : 35 < d && 90 >= d
                    ? (l = "start" === f ? 0.25 * -k.height : k.height)
                    : 215 < d &&
                      270 >= d &&
                      (l = "start" === f ? k.height : 0.25 * -k.height);
                  15 > D
                    ? (e = "start" === f ? 0.15 * -k.height : 0.15 * k.height)
                    : 165 < D &&
                      180 >= D &&
                      (e = "start" === f ? 0.15 * k.height : 0.15 * -k.height);
                  t.attr({ align: A });
          ...
          v(d.prototype, "getMarkPath", function (b, a, t, k, g, u, m) {
            var A = this.axis;
            A.isRadial
              ? ((b = A.getPosition(this.pos, A.center[2] / 2 + k)),
                (a = ["M", a, t, "L", b.x, b.y]))
              : (a = b.call(this, a, t, k, g, u, m));
            return a;
          });
        };
        a.defaultCircularOptions = {
      ...
      a = (function (a) {
        ...
        f.prototype.translate = function () {
          ...
          b.points.forEach(function (g) {
            ...
            g.isNull
              ? (g.plotY = null)
              : ((g.plotLow = m),
                (g.plotHigh = a.translate(
                  k ? b.modifyValue(u, g) : u,
                  0,
                  1,
                  0,
                  1
                )),
                k && (g.yBottom = g.plotHigh));
          });
          this.chart.polar &&
            this.points.forEach(function (g) {
              b.highToXY(g);
              g.tooltipPos = [
                (g.plotHighX + g.plotLowX) / 2,
                (g.plotHigh + g.plotLow) / 2,
              ];
            });
        };
        f.prototype.getGraphPath = function (b) {
          ...
          for (g = b.length; g--; ) {
            var f = b[g];
            var p = A
              ? { plotX: f.rectPlotX, plotY: f.yBottom, doCurve: !1 }
              : { plotX: f.plotX, plotY: f.plotY, doCurve: !1 };
            f.isNull || x || h || (b[g + 1] && !b[g + 1].isNull) || k.push(p);
            var d = {
              polarPlotY: f.polarPlotY,
              rectPlotX: f.rectPlotX,
              yBottom: f.yBottom,
              plotX: C(f.plotHighX, f.plotX),
              plotY: f.plotHigh,
              isNull: f.isNull,
            };
            k.push(d);
          ...
          c &&
            (!0 === c && (c = "left"),
            (m.step = { left: "right", center: "center", right: "left" }[c]));
          a = u.call(this, a);
          k = u.call(this, k);
          m.step = c;
          m = [].concat(b, a);
            ...
            if (x.enabled || this._hasPointLabels) {
              for (k = t; k--; )
                if ((m = a[k])) {
                  ...
                  m.below = c;
                  A
                    ? x.align || (x.align = c ? "right" : "left")
                    : x.verticalAlign ||
                      (x.verticalAlign = c ? "top" : "bottom");
                }
              ...
              for (k = t; k--; )
                if ((m = a[k]))
                  (c = h.inside
                    ...
                    (m.below = !c),
                    A
                      ? h.align || (h.align = c ? "left" : "right")
                      : h.verticalAlign ||
                        (h.verticalAlign = c ? "bottom" : "top");
        ...
        f.prototype.drawPoints = function () {
          ...
          for (t = 0; t < a; ) {
            ...
            this.chart.polar ||
              (k.isInside = k.isTopInside =
                "undefined" !== typeof k.plotY &&
                0 <= k.plotY &&
                k.plotY <= this.yAxis.len &&
                0 <= k.plotX &&
          ...
          for (t = 0; t < a; )
            (k = this.points[t]),
              (k.upperGraphic = k.graphic),
              (k.graphic = k.lowerGraphic),
              k.origProps && (p(k, k.origProps), delete k.origProps),
              t++;
        };
        f.defaultOptions = H(c.defaultOptions, {
          lineWidth: 1,
          threshold: null,
          tooltip: {
            pointFormat:
        ...
        d.prototype.translate = function () {
          ...
          a.points.forEach(function (x) {
            ...
            u
              ? ((k = x.barX + t),
                (x.shapeType = "arc"),
                (x.shapeArgs = a.polarArc(e + l, e, k, k + x.pointWidth)))
              : ((f.height = l),
                (f.y = e),
                (d = f.x),
                (d = void 0 === d ? 0 : d),
                (f = f.width),
                (f = void 0 === f ? 0 : f),
                (x.tooltipPos = g.inverted
                  ? [
                      c.len + c.pos - g.plotLeft - e - l / 2,
                      h.len + h.pos - g.plotTop - d - f / 2,
                      l,
                    ]
                  : [
                      h.left - g.plotLeft + d + f / 2,
                      c.pos - g.plotTop + e + l / 2,
                      l,
                    ]));
          });
        };
        ...
        d.prototype.translate = function () {
          ...
          b.points.forEach(function (a) {
            ...
            a.tooltipPos = c.inverted
              ? [e.len + e.pos - c.plotLeft - x, b.xAxis.len - u - h, m]
              : [u + h, x + e.pos - c.plotTop, m];
            x = l + (a.total || a.y);
            "percent" === f.stacking && (x = l + (0 > a.y) ? -100 : 100);
            x = e.toPixels(x, !0);
            var D = (p = c.plotHeight - x - (c.plotHeight - q))
              ? (h * (d - x)) / p
              : 0;
            var z = p ? (h * (d + m - x)) / p : 0;
            p = u - D + h;
      ...
      a = (function (a) {
        ...
        b.prototype.translate = function () {
          ...
          this.points.forEach(function (t) {
            ...
            if (w(f) || !1 === a.wrap)
              (f = w(f) ? (f / 180) * Math.PI : 0),
                (d = q(d, b.startAngleRad - f, b.endAngleRad + f));
            d = (180 * d) / Math.PI;
            t.shapeType = "path";
            t.shapeArgs = {
              d: k.path || [
        ...
        b.prototype.drawPoints = function () {
          ...
          b.points.forEach(function (g) {
            ...
            c
              ? (c.animate(m), (m.d = t))
              : (g.graphic = u[g.shapeType](m)
                  .attr({ rotation: m.rotation, zIndex: 1 })
                  .addClass("highcharts-dial")
                  .add(b.group));
            if (!a.styledMode)
              g.graphic[c ? "animate" : "attr"]({
                stroke: f.borderColor || "none",
                "stroke-width": f.borderWidth || 0,
                fill: f.backgroundColor || d.neutralColor100,
              });
          });
          t
            ? t.animate({ translateX: c[0], translateY: c[1] })
            : ((b.pivot = u
                .circle(0, 0, p(g.radius, 5))
                .attr({ zIndex: 2 })
              ...
              a.styledMode ||
                b.pivot.attr({
                  ...
                  stroke: g.borderColor || d.neutralColor20,
                  fill: g.backgroundColor || d.neutralColor100,
                }));
        };
          ...
          b.points.forEach(function (h) {
            ...
            "undefined" !== typeof h.plotY &&
              ...
              c.styledMode ||
                ...
                (K.dashstyle =
                  h.stemDashStyle || a.stemDashStyle || a.dashStyle),
                h.stem.attr(K),
                w &&
                  ((C.stroke = h.whiskerColor || a.whiskerColor || B),
                  (C["stroke-width"] = q(
                    h.whiskerWidth,
                    a.whiskerWidth,
                    a.lineWidth
                  ...
                  (C.dashstyle =
                    h.whiskerDashStyle || a.whiskerDashStyle || a.dashStyle),
                  h.whiskers.attr(C)),
                J &&
                  ((z.fill = h.fillColor || a.fillColor || B),
                  (z.stroke = a.lineColor || B),
                  (z["stroke-width"] = a.lineWidth || 0),
                  (z.dashstyle =
                    h.boxDashStyle || a.boxDashStyle || a.dashStyle),
                  h.box.attr(z)),
                ...
                (L.dashstyle =
                  h.medianDashStyle || a.medianDashStyle || a.dashStyle),
      ...
      a = (function (a) {
          ...
          for (a = e.length; l < a; l++) {
            ...
            if (x) {
              if (f) {
                ...
                if ("overlap" === x) {
                  ...
                  z = 0 <= q ? z : z - q;
                  Object.hasOwnProperty.call(v, "absolutePos") &&
                    delete v.absolutePos;
                  Object.hasOwnProperty.call(v, "absoluteNeg") &&
                    delete v.absoluteNeg;
                } else
                  0 <= q
                    ? ((z = v.threshold + v.posTotal), (v.posTotal -= q))
                    : ((z = v.threshold + v.negTotal),
                      (v.negTotal -= q),
                      (z -= q)),
                    !v.posTotal &&
                      Object.hasOwnProperty.call(v, "absolutePos") &&
                      ((v.posTotal = v.absolutePos), delete v.absolutePos),
                    !v.negTotal &&
                      Object.hasOwnProperty.call(v, "absoluteNeg") &&
                      ((v.negTotal = v.absoluteNeg), delete v.absoluteNeg);
                ...
                if ((q = b.waterfall.dummyStackItem))
                  (q.x = l),
                    (q.label = f[l].label),
                    q.setOffset(
                      this.pointXOffset || 0,
              ...
              (z = Math.max(h, h + q) + v[0]),
                ...
                p.isSum
                  ? ((n.y = b.translate(v[1], 0, 1, 0, 1)),
                    (n.height =
                      Math.min(b.translate(v[0], 0, 1, 0, 1), b.len) - n.y))
                  : p.isIntermediateSum
                  ? (0 <= q
                      ? ((r = v[1] + g), (q = g))
                      : ((r = g), (q = v[1] + g)),
                    b.reversed && ((r ^= q), (q ^= r), (r ^= q)),
                    (n.y = b.translate(r, 0, 1, 0, 1)),
                    (n.height = Math.abs(
                      n.y - Math.min(b.translate(q, 0, 1, 0, 1), b.len)
                    )),
                    (g += v[1]))
                  : ((n.height =
                      0 < r
                        ? b.translate(h, 0, 1, 0, 1) - n.y
                        : b.translate(h, 0, 1, 0, 1) -
                          b.translate(h - r, 0, 1, 0, 1)),
                    (h += r),
                    (p.below = h < y(d, 0))),
            ...
            n.height <= c && !p.isNull
              ? ((n.height = c),
                (n.y -= m),
                (p.plotY = n.y),
                (p.minPointLengthOffset = 0 > p.y ? -m : m))
              : (p.isNull && (n.width = 0), (p.minPointLengthOffset = 0));
            n = p.plotY + (p.negative ? n.height : 0);
            this.chart.inverted
              ? (p.tooltipPos[0] = b.len - n)
              : (p.tooltipPos[1] = n);
          }
        };
        c.prototype.processData = function (b) {
          ...
          for (l = h = f = t = e = 0; l < m; l++) {
            ...
            "sum" === p || n.isSum
              ? (g[l] = v(h))
              : "intermediateSum" === p || n.isIntermediateSum
              ? ((g[l] = v(f)), (f = 0))
              : ((h += p), (f += p));
            t = Math.min(h, t);
            e = Math.max(h, e);
            ...
            v &&
              ...
              h
                ? ((v = v.connectorThreshold),
                  (q =
                    Math.round(b.translate(v, 0, 1, 0, 1) + (d ? q : 0)) - c))
                : (q = r.y + n.minPointLengthOffset + m - c),
              e.push(
                ["M", (r.x || 0) + (f ? 0 : r.width || 0), q],
                ["L", (p.x || 0) + (f ? p.width || 0 : 0), q]
              ));
            r &&
              e.length &&
              ((!h && 0 > n.y && !d) || (0 < n.y && d)) &&
        ...
        c.defaultOptions = C(w.defaultOptions, {
          dataLabels: { inside: !0 },
          lineWidth: 1,
          lineColor: d.neutralColor80,
          dashStyle: "Dot",
          borderColor: d.neutralColor80,
    ...
    function (e, c, d, l) {
      ...
      l = (function (c) {
        ...
        d.prototype.getGraphPath = function () {
          for (
            var a = q.prototype.getGraphPath.call(this), b = a.length + 1;
            b--;
        ...
        d.defaultOptions = b(w.defaultOptions, {
    ...
    function (e, c, d, l, a, n, f, r, q) {
        ...
        legend: {
          bubbleLegend: {
            ...
            labels: {
              ...
              formatter: void 0,
              align: "right",
              style: { fontSize: "10px", color: f.neutralColor100 },
              x: 0,
              y: 0,
            },
            maxSize: 60,
      ...
      f = (function () {
        ...
        a.prototype.setOptions = function () {
          ...
          a.forEach(function (k, u) {
            e ||
              ((m.stroke = y(k.borderColor, b.borderColor, g.color)),
              (m.fill = y(
                k.color,
                b.color,
                1 !== h ? w(g.color).setOpacity(h).get("rgba") : g.color
              )),
              (d.stroke = y(k.connectorColor, b.connectorColor, g.color)));
            a[u].radius = this.getRangeRadius(k.value);
            a[u] = C(a[u], { center: a[0].radius - a[u].radius + c });
            e ||
              C(!0, a[u], {
                bubbleAttribs: C(m),
                connectorAttribs: C(d),
                labelAttribs: f,
              });
          }, this);
        };
        ...
        a.prototype.renderRange = function (a) {
          ...
          f.bubbleItems.push(
            d
              ...
              .addClass(
                (q ? "highcharts-color-" + m.colorIndex + " " : "") +
        ...
        a.prototype.hideOverlappingLabels = function () {
          ...
          !this.options.labels.allowOverlap &&
            ...
            b.labels.forEach(function (a, c) {
              a.newOpacity
                ? a.newOpacity !== a.oldOpacity && b.connectors[c].show()
                : b.connectors[c].hide();
            }));
        };
          ...
          a.chart.series.forEach(function (a) {
            a.isBubble &&
              ...
              g.length &&
                ...
                (d = y(a.options.zMax, Math.max(d, h(g))))));
          });
          var f =
            c === d
              ? [{ value: d }]
      ...
      c(a, "afterGetAllItems", function (a) {
        ...
        0 <= d &&
          ...
          g.enabled &&
          ((g.seriesIndex = d),
          (this.bubbleLegend = new l.BubbleLegend(g, this)),
      ...
      a.prototype.getLinesHeights = function () {
        ...
        for (g = 0; g < c; g++)
          if (
            ...
            var m = b[b.length - 1];
            for (d; d <= g; d++)
              a[d].itemHeight > m.height && (m.height = a[d].itemHeight);
            m.step = g;
          }
        return b;
      };
      a.prototype.retranslateItems = function (a) {
        ...
        this.allItems.forEach(function (k, f) {
          ...
          if ((g = k.movementX) || (d && k.ranges))
            (g = d ? b - k.options.maxSize / 2 : b + g),
      ...
      c(r, "legendItemClick", function () {
        ...
        c &&
          ...
          c.bubbleLegend.visible !== a &&
            (c.update({ bubbleLegend: { enabled: a } }),
            (c.bubbleLegend.visible = a)),
          (this.visible = b));
      });
      ...
      e.prototype.beforePadding = function () {
        ...
        G.length &&
          ...
          [
            ...
            "undefined" === typeof F(a.options[b[0]], a[b[1]]) &&
              (a[b[0]] += b[2] / H);
          }));
      };
      ...
      e.networkgraphIntegrations = {
        verlet: {
          ...
          attractive: function (c, d, e) {
            ...
            c.fromNode.fixedPosition ||
              ((c.fromNode.plotX -= (l * a.fromNode) / c.fromNode.degree),
              (c.fromNode.plotY -= (d * a.fromNode) / c.fromNode.degree));
            c.toNode.fixedPosition ||
              ((c.toNode.plotX += (l * a.toNode) / c.toNode.degree),
              (c.toNode.plotY += (d * a.toNode) / c.toNode.degree));
          },
        ...
        euler: {
          ...
          attractive: function (c, d, e, a) {
            ...
            d *= e.y / a;
            c.fromNode.fixedPosition ||
              ((c.fromNode.dispX -= (f * l.fromNode) / c.fromNode.degree),
              (c.fromNode.dispY -= (d * l.fromNode) / c.fromNode.degree));
            c.toNode.fixedPosition ||
              ((c.toNode.dispX += (f * l.toNode) / c.toNode.degree),
              (c.toNode.dispY += (d * l.toNode) / c.toNode.degree));
          },
          integrate: function (c, d) {
            d.dispX += d.dispX * c.options.friction;
            d.dispY += d.dispY * c.options.friction;
            var e = (d.temperature = c.vectorLength({
              x: d.dispX,
              y: d.dispY,
            }));
            0 !== e &&
              ((d.plotX +=
                (d.dispX / e) * Math.min(Math.abs(d.dispX), c.temperature)),
              (d.plotY +=
                (d.dispY / e) * Math.min(Math.abs(d.dispY), c.temperature)));
          },
          getK: function (c) {
      ...
      r(d.layouts["reingold-fruchterman"].prototype, {
        ...
        setCircularPositions: function () {
          function a(b) {
            b.linksFrom.forEach(function (b) {
              r[b.toNode.id] ||
                ((r[b.toNode.id] = !0), l.push(b.toNode), a(b.toNode));
            });
          }
          var c = this.box,
            d = this.nodes,
        ...
        attractiveForces: function () {
          ...
          a.links.forEach(function (b) {
            b.fromNode &&
              b.toNode &&
              ((c = a.getDistXY(b.fromNode, b.toNode)),
              (d = a.vectorLength(c)),
              0 !== d &&
                ((e = a.attractiveForce(d, a.k)),
                a.force("attractive", b, e, c, d)));
          });
        },
      ...
      c.networkgraphIntegrations.packedbubble = {
        ...
        barycenter: function () {
          ...
          b.forEach(function (h) {
            a.options.splitSeries && !h.isParentNode
              ? ((e = h.series.parentNode.plotX),
                (f = h.series.parentNode.plotY))
              : ((e = d.width / 2), (f = d.height / 2));
            h.fixedPosition ||
              ((h.plotX -=
                ((h.plotX - e) * c) / (h.mass * Math.sqrt(b.length))),
              (h.plotY -=
                ((h.plotY - f) * c) / (h.mass * Math.sqrt(b.length))));
          });
        },
          ...
          d.forEach(function (d, h) {
            a.options.splitSeries && !d.isParentNode
              ? ((e = d.series.parentNode.plotX),
                (l = d.series.parentNode.plotY))
              : ((e = c.width / 2), (l = c.height / 2));
        ...
        repulsiveForces: function () {
          ...
          a.nodes.forEach(function (f) {
            ...
            a.nodes.forEach(function (h) {
              ...
              f === h ||
                f.fixedPosition ||
                (!a.options.seriesInteraction && f.series !== h.series) ||
                ((b = a.getDistXY(f, h)),
                (d =
                  a.vectorLength(b) - (f.marker.radius + h.marker.radius + e)),
                0 > d &&
                  ((f.degree += 0.01),
                  f.neighbours++,
                  (c = a.repulsiveForce(
                    -d / Math.sqrt(f.neighbours),
                    a.k,
                    f,
                    h
                  ))),
                a.force("repulsive", f, c * h.mass, b, h, d));
            });
          });
        },
    ...
    function (e, c, d, l, a) {
      ...
      e = (function (a) {
        ...
        d.prototype.addLayout = function () {
          ...
          var f = b[a.type];
          f ||
            ((a.enableSimulation = h(e.forExport)
              ? !e.forExport
              : a.enableSimulation),
            (b[a.type] = f = new c.layouts[a.type]()),
            f.init(a),
        ...
        d.prototype.addSeriesLayout = function () {
          var a = this.options.layoutAlgorithm,
            b = this.chart.graphLayoutsStorage,
            d = this.chart.graphLayoutsLookup,
            e = I(a, a.parentNodeOptions, {
              enableSimulation: this.layout.options.enableSimulation,
            });
          var f = b[a.type + "-series"];
          f ||
            ((b[a.type + "-series"] = f = new c.layouts[a.type]()),
            f.init(e),
            d.splice(f.index, 0, f));
        ...
        d.prototype.drawGraph = function () {
          if (this.layout && this.layout.options.splitSeries) {
            ...
            var c = {
              fill: b.fillColor || f(this.color).brighten(0.4).get(),
          ...
          if (a.fixedPosition && !a.removed) {
            ...
            g &&
              ...
              g.nodes.forEach(function (g) {
                a &&
                  a.marker &&
                  g !== a.series.parentNode &&
                  ((b = d.getDistXY(a, g)),
                  (c = d.vectorLength(b) - g.marker.radius - a.marker.radius),
                  0 > c &&
                    (g.series.addPoint(
                      I(a.options, { plotX: a.plotX, plotY: a.plotY }),
                      !1
                    ),
        ...
        d.prototype.placeBubbles = function (a) {
          ...
          if (a.length) {
            ...
            if (1 < a.length)
              for (
                d.push([[0, 0 - a[1][2] - a[0][2], a[1][2], a[1][3], a[1][4]]]),
                  h = 2;
                h < a.length;
                h++
              )
                (a[h][2] = a[h][2] || 1),
                  (k = c(d[g][e], d[g - 1][f], a[h])),
                  b(k, d[g][0])
                    ? (d.push([]),
                      (f = 0),
                      d[g + 1].push(c(d[g][e], d[g][0], a[h])),
                      g++,
                      (e = 0))
                    : 1 < g && d[g - 1][f + 1] && b(k, d[g - 1][f + 1])
                    ? (f++, d[g].push(c(d[g][e], d[g - 1][f], a[h])), e++)
                    : (e++, d[g].push(k));
            this.chart.stages = d;
        ...
        d.prototype.resizeRadius = function () {
          ...
          if (1e-10 < Math.abs(c - 1)) {
            ...
            (a.diffY = k / 2 + f - l - (n - l) / 2),
              (a.diffX = h / 2 + e - q - (r - q) / 2);
        };
        ...
        d.prototype.translate = function () {
          ...
          if (e) var f = a.allDataPoints;
            ...
            (f = this.placeBubbles(a.allDataPoints)),
          ...
          for (d = 0; d < f.length; d++)
            if (f[d][3] === c) {
              ...
              e ||
                ((k.plotX = f[d][0] - a.plotLeft + a.diffX),
                (k.plotY = f[d][1] - a.plotTop + a.diffY));
              B(l) &&
                ((k.marker = p(k.marker, {
                  radius: l,
                  width: 2 * l,
    ...
    function (e, c, d, l, a, n, f, r, q) {
      ...
      F.toXY = function (a) {
        ...
        h &&
          k &&
          !k.isRadialBar &&
          (a.plotY = f = "number" === typeof l ? d.translate(l) || 0 : 0);
        a.rectPlotX = e;
        a.rectPlotY = f;
        d.center && (n += d.center[3] / 2);
        v(f) &&
          ((d = h ? d.postTranslate(f, n) : c.postTranslate(e, n)),
      ...
      f.spline &&
            ...
            ? d
              ? ((a = this.getConnectors(b, d, !0, this.connectEnds)),
                ...
                (a = [
                  ...
                  v(b) ? b : a.plotX,
                  v(c) ? c : a.plotY,
                  v(a.leftContX) ? a.leftContX : a.plotX,
                  v(a.leftContY) ? a.leftContY : a.plotY,
                  a.plotX,
                  a.plotY,
                ]))
              : (a = ["M", c.plotX, c.plotY])
        ...
        f.areasplinerange &&
          (f.areasplinerange.prototype.getPointSpline =
            f.spline.prototype.getPointSpline));
      b(
        n,
        "afterTranslate",
        function () {
          ...
          if (a.polar && this.xAxis) {
            ...
            if (!this.preventPostTranslate)
              for (var c = this.points, e = c.length; e--; )
                this.toXY(c[e]),
                  !a.hasParallelCoordinates &&
                    !this.yAxis.reversed &&
                    c[e].y < this.yAxis.min &&
                    (c[e].isNull = !0);
        ...
        if (e.polar)
          if (c.isRadialBar)
            b ||
              ...
              d.seriesTypes.pie.prototype.animate.call(c, b));
          else {
            if (e.renderer.isSVG)
            ...
            for (; e--; ) {
              ...
              if (d.inverted) {
                ...
                if (c && f.stacking) {
                  if (
                    ((C =
                      f.stacking.stacks[(0 > C ? "-" : "") + this.stackKey]),
                    this.visible && C && C[z] && !b.isNull)
                  ) {
                    var B =
                      C[z].points[
                ...
                b.plotY =
                  (h(this.translatedThreshold) &&
                    (E < this.translatedThreshold ? E : B)) - n;
              } else
                (E = y + n),
            ...
            ? ((a = (b.rectPlotX / Math.PI) * 180),
              g.inverted
                ? ((this.forceDL = g.isInsidePlot(
                  ...
                  (d.align = y(d.align, "center")),
                  (d.verticalAlign = y(d.verticalAlign, "middle")))
