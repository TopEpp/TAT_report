		...
		<div class="card">
			<div class="card-header">
				<div class="row align-items-end">
					<div class="col-md-3 col-12 mb-2 mb-md-0" style="font-size:1.1em;">Log Export Info</div>
...
<script type="text/javascript">
	...
	function ChangeFilter() {
		...
		window.location.href = base_url + '/setting/log_info?start=' + start + '&end=' + end;
	}

	function ExportExcel() {
		var start = toCeDmy($('#start_date').val());
		var end = toCeDmy($('#end_date').val());
		window.location.href = base_url + '/setting/log_info?start=' + start + '&end=' + end + '&export_type=excel';
	}
