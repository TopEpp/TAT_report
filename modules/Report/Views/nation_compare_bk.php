...
<div class="row">
	...
	<div class="col-md-2 col-2" >
		<select class="form-control" id="show_type">
			<option value="region" <?php if(@$show_type=='region'){ echo "selected='selected'";} ?> >Region</option>
			<option value="country" <?php if(@$show_type=='country'){ echo "selected='selected'";} ?> >Country</option>
		</select>
	</div>
			...
			<table class="table table-striped table-bordered">
				...
				<?php foreach($region[0] as $re){ ?>
					...
					<?php if(!empty($region[$re['MD_STD_REG_ID']])){ 
						...
						<?php $sum1 = $sum2 = $sum_diff = 0; $sum_compare = '';
