...
<table style="width:100%">
	<tr>
		<td class="headderTable">
			<b>รายงานจำนวนนักท่องเที่ยวที่เดินทางเข้าประเทศไทย รายด่าน (สะสม)</b>
		</td>
	</tr>
</table>
			...
			<tr>
				...
				<?php if (!empty($port_colunm)) {
					foreach ($port_colunm as $p) { ?>
						<th style="background:#379FA6;border: 1px solid black ;" colspan="<?php echo count($period)+1 ?>"><?php echo $p['PORT_NAME'] ?></th>
				<?php }
				} ?>
			</tr>
			<tr>
